...
public class GeneralSearch extends JFrame {
	...
	private final JLabel lblExculdeTheseAuthors = new JLabel("Publication:");
	...
	private final JLabel lblJournalIssn = new JLabel("Journal ISSN:");
	private final JTextField textField_1 = new JTextField();
	private final JLabel lblNewLabel = new JLabel("All of the words:");
	private final JLabel lblNewLabel_2 = new JLabel("None of the words:");
...
//			public void run() {
//				try {
//					GeneralSearch frame = new GeneralSearch();
...
//		setContentPane(contentPane);
		...
		label.setBounds(16, 21, 126, 29);
		
		panel.add(label);
		textField.setColumns(10);
		textField.setBounds(154, 25, 722, 20);
		...
		panel.add(button_1);
		choice.setBounds(108, 215, 157, 22);
		
		panel.add(choice);
		label_2.setBounds(16, 215, 84, 16);
		
		panel.add(label_2);
		label_3.setBounds(16, 187, 181, 16);
		
		panel.add(label_3);
		lblExculdeTheseAuthors.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		lblExculdeTheseAuthors.setBounds(16, 63, 78, 16);
		
		panel.add(lblExculdeTheseAuthors);
		textField_2.setColumns(10);
		textField_2.setBounds(154, 57, 722, 28);
		
		panel.add(textField_2);
		textField_3.setColumns(10);
		textField_3.setBounds(209, 181, 56, 28);
		
		panel.add(textField_3);
		label_5.setBounds(277, 187, 61, 16);
		
		panel.add(label_5);
		textField_4.setColumns(10);
		textField_4.setBounds(309, 181, 67, 28);
		...
		lblJournalIssn.setBounds(16, 94, 84, 16);
		
		panel.add(lblJournalIssn);
		textField_1.setColumns(10);
		textField_1.setBounds(154, 88, 722, 28);
		
		panel.add(textField_1);
		lblNewLabel.setBounds(16, 122, 107, 16);
		
		panel.add(lblNewLabel);
		lblNewLabel_2.setBounds(16, 149, 126, 16);
		
		panel.add(lblNewLabel_2);
		textField_5.setColumns(10);
		textField_5.setBounds(154, 116, 722, 28);
		
		panel.add(textField_5);
		textField_6.setColumns(10);
		textField_6.setBounds(154, 147, 722, 28);
